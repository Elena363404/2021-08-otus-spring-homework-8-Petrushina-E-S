package ru.otus.elena363404.changelog;
...
public class DatabaseChangelog {
    ...
    public void initComment(CommentRepository repository) {
        repository.save(new Comment("Good book!", bookList.get(0)));
        repository.save(new Comment("Bad book!", bookList.get(0)));
        repository.save(new Comment("Norm book!", bookList.get(1)));
    }
